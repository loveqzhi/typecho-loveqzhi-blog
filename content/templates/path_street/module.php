...
function neighbor_log($neighborLog){
	...
	<ul>
	<?php if($prevLog):?>
		<li class="post_pre">&laquo; <a href="<?php echo Url::log($prevLog['gid']) ?>"><?php echo $prevLog['title'];?></a></li><span class="post_pre_n_nex_null"></span>
	<?php endif;?>
	<?php if($nextLog):?>
		<li class="post_nex"> <a href="<?php echo Url::log($nextLog['gid']) ?>"><?php echo $nextLog['title'];?></a> &raquo;</li><span class="post_pre_n_nex_null post_pre_n_nex_nex_null"></span>
	<?php endif;?>
	</ul>	
<?php }?>
<?php
...
function blog_comments($comments){
	...
	<div id="comments">
	<a name="comments"></a>
	<h4>已有<?php echo count($comments);?>条评论</h4>
	...
	?>
	<li id="comment-<?php echo $comment['cid']; ?>" class="comment-body comment-parent comment-odd comment-by-author">
		<a name="<?php echo $comment['cid']; ?>"></a>
		<div class="comment-author">
			<?php if($isGravatar == 'y'): ?>
				<img class="avatar" src="<?php echo getGravatar($comment['mail']); ?>" alt="" width="48" height="48" />
			<?php endif; ?>
		</div>
		<div class="comment-meta">
			...
			<a class="comment-reply" href="#comment-<?php echo $comment['cid']; ?>" onclick="commentReply(<?php echo $comment['cid']; ?>,this)">回复</a><br />
		</div>
		<div class="comment-p">
...
function blog_comments_children($comments, $children){
	...
	$comment['poster'] = $comment['url'] ? '<a href="'.$comment['url'].'" target="_blank">'.$comment['poster'].'</a>' : $comment['poster'];
	?>
			<li id="comment-<?php echo $comment['cid']; ?>" class="comment-body comment-child comment-level-odd comment-odd comment-by-author">
				<a name="<?php echo $comment['cid']; ?>"></a>
				<div class="comment-author">
					<?php if($isGravatar == 'y'): ?>
						<img class="avatar" src="<?php echo getGravatar($comment['mail']); ?>" alt="" width="48" height="48" />
		...
		<form method="post" action="<?php echo BLOG_URL; ?>index.php?action=addcom" id="comment_form">
			...
			<?php if(ROLE == 'visitor'): ?>
				<p>
					...
					<input type="text" tabindex="1" name="comname" maxlength="49" id="author" class="text" value="<?php echo $ckname; ?>" />
				</p>
				<p>
					<label for="mail">邮箱</label>
					<input type="text" tabindex="2" name="commail" maxlength="128" id="mail" class="text" value="<?php echo $ckmail; ?>" />
				</p>
				<p>
					<label for="url">网站</label>
					<input type="text" tabindex="3" name="comurl" maxlength="128" id="url" class="text" value="<?php echo $ckurl; ?>" />
				</p>
			...
			<?php endif; ?>
				<p>
					<input type="submit" tabindex="5" value="提交评论" class="submit" id="submit">
